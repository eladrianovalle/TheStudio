...
- **Trigger-offloadable:** Content needed only during specific workflows (e.g., "Running a Studio Phase" — only relevant when the agent is about to run a phase). Offload with a strong inline stub that names the trigger condition.
