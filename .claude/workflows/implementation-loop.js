...
function editorPrompt(u, writer) {
  ...
  return [
    ...
    `quote what you read there. An index summary or an inlined source excerpt is never the quote, whatever`,
    `the tool claims its excerpt is enough for. A quote taken from a summary rather than the file is`,
